...
The design prioritizes clarity and simplicity. This means no external libraries beyond Python's built-in "math" module (except Matplotlib for plotting of course). I used Euclidean distance for clustering, handled edge cases like empty clusters, and implemented convergence detection to ensure the algorithm terminates properly.

This project deepened my understanding of clustering algorithms and reinforced core Python fundamentals. Credit to Justin Skycak's book "Introduction to Algorithms and Machine Learning" for helping me to get started.
